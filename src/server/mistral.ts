...
export const NON_RELEVANT_REPLY =
  "Ik kan u helpen met algemene vragen over betalingen, ontvangen brieven, betalingsregelingen en de dienstverlening van BoitenLuhrs. Heeft u daar een vraag over? Ik help u graag verder.";
...
`;
    ...
    // return reply === "ja";
    console.log(
      "[Mistral] Uitkomst relevantiecheck:",
    ...
    throw new Error(
      "Mistral gaf geen geldige ja/nee-classificatie.",
    );
  }
}
